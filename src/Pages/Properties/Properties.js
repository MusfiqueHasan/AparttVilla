...
import { Button, Card, CardContent, CardMedia, Divider, Fab, Grid, Typography } from '@mui/material';
...
const Properties = ({ property, handleServiceDetails }) => {
        ...
        <Grid item xs={12} md={4} sx={{ pb: 5 }}>
            <Card sx={{ maxWidth: 345, }}>
                ...
                <Box style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <Button onClick={() =>handleServiceDetails(_id)}>
